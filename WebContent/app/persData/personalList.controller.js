sap.ui.controller("app.persData.personalList", {
	...
	loadContent : function() {
		...
		view.personalList.bindItems("/PersoonSet",
				view.personalItemTemplate);
	},
	...
	onDeleteButton : function() {
		sap.m.MessageBox.show(oBundle.getText("DELETE_FAMILY"), "", oBundle
				.getText("DELETE_ROW_DEL"), [ sap.m.MessageBox.Action.YES,
	...
	onEditButton : function(oEvent) {
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
			viewId : "app.persData.personalDetailEdit",
			data : {
