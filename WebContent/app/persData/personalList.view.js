...
//                            	 layoutdata: new sap.ui.layout.ResponsiveFlowLayoutData({weight : 2,}),
                             ...
                             formElements: [            
                                     ...
                                     new sap.ui.layout.form.FormElement({label: oBundle.getText("COUNTRYBIRTH"),fields: [new sap.m.Text({text: "{Nameofcountryofbirth}"}),]}),
                                     ...
                                     new sap.ui.layout.form.FormElement({label: oBundle.getText("SECONDNATIONALITY"),fields: [new sap.m.Text({text: "{Nameofsecondnationality}"}),]}),
                                     new sap.ui.layout.form.FormElement({label: oBundle.getText("LANGUAGE"),fields: [new sap.m.Text({text: "{Nameoflanguage}"}),]}),
                                     ...
                                     new sap.ui.layout.form.FormElement({label: oBundle.getText("ACADEMICTITLE"),fields: [new sap.m.Text({text: "{Academicgrade}"}),]}),
                                     
                                     new sap.ui.layout.form.FormElement({
                                         label: "",
                                         fields: [new sap.m.Button({icon : "sap-icon://edit",layoutData: new sap.ui.layout.GridData({span: "L1 M1 S2", indent: "L10 M10 S8",}),press: oController.onEditButton}), 
